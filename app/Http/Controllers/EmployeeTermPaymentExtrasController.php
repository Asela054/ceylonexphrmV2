	...
	*/
	...
	public function downloadSalarySheet(Request $request){
		...
		*/
		...
		$term_extras = DB::select($sql_paydata, [$paymentPeriod->payment_period_fr, $paymentPeriod->payment_period_fr, $paymentPeriod->payment_period_to, $paymentPeriod->payment_period_to, $paymentPeriod->created_at->format('Y-m-d'), $paymentPeriod->advance_payment_date, $request->rpt_remuneration_id, $paymentPeriod->created_at->format('Y-m-d'), $paymentPeriod->advance_payment_date, $request->rpt_remuneration_id]);
	...
	public function checkPayRegister(Request $request){
		if($request->ajax()){
			...
			*/
			...
			$term_extras = DB::select($sql_paydata, [$paymentPeriod->payment_period_fr, $paymentPeriod->payment_period_fr, $paymentPeriod->payment_period_to, $paymentPeriod->payment_period_to, $paymentPeriod->created_at->format('Y-m-d'), $paymentPeriod->advance_payment_date, $paymentPeriod->created_at->format('Y-m-d'), $paymentPeriod->advance_payment_date]);
