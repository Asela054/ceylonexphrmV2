                                                    ...
                                                    <div class="sbp-preview-content">
                                                       ...
                                                       <div class="row">
                                                           ...
                                                           <div class="form-group col-md-6">
                                                               ...
                                                               <div class="col">
                                                                 <input type="text" name="employees_extra_entitle_amount" id="employees_extra_entitle_amount" class="form-control" readonly="readonly" />
                                                               </div>
                                                           </div>
                                                       </div>
                                           ...
                                           <div class="sbp-preview-content" style="padding:15px 5px;">
                                               ...
                                               <div class="row">
                                                   <div class="form-group col-md-6">
                                                       ...
                                                       <div class="col">
                                                         <select name="remuneration_extra_id" id="remuneration_extra_id" class="form-control" >
                                                   ...
                                                   <div class="form-group col-md-6">
                                                       ...
                                                       <div class="col">
                                                         <input type="text" name="employee_extra_entitle_amount" id="employee_extra_entitle_amount" class="form-control" autocomplete="off" />
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>
