                        ...
                        <div class="container-fluid">
                            <div class="page-header-content py-3 px-2">
                                <h1 class="page-header-title ">
                                    ...
                                    <span>Employee Advance/Bonus Payments</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                                    ...
                                    {{ csrf_field() }}
                                        <div class="card">
                                            ...
                                            <div class="card-header">
                                                ...
                                                lbl-duration span html
                                                
                                                search/download button html
                                            ...
                                            <div class="card-body p-0 p-2">
                                                <div class="row">
                                                	<div class="col-12 text-right">
                                                    	<div>
                                                            ...
                                                            <button type="submit" name="print_record" id="print_record_pdf" disabled="disabled" class="btn btn-secondary btn-sm btn-light" onclick="this.form.action='{{ url('DownloadExtrasPaysheet') }}'">Download</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <input type="hidden" name="rpt_remuneration_id" id="rpt_remuneration_id" value="" />
                                   ...
                                   <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                   <select name="location_filter_id" id="location_filter_id" class="form-control form-control-sm shipClass nest_head" style="" data-findnest="deptnest" >
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                   <select name="department_filter_id" id="department_filter_id" class="form-control form-control-sm" style="" data-nestname="deptnest" >
                                                        <option value="" selected="selected">Please Select</option><!-- disabled="disabled" -->
                                        ...
                                        <div class="row">
                                        	<div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                 <select name="payroll_process_type_id" id="payroll_process_type_id" class="form-control form-control-sm" ><!-- disabled="disabled" -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col">
                                                   <select name="period_filter_id" id="period_filter_id" class="form-control form-control-sm" style="" ><!-- disabled="disabled" -->
                                                        <option value="" disabled="disabled" selected="selected">Please Select</option>
                                        	...
                                        	<div class="form-group col-md-12">
                                                ...
                                                <div class="col">
                                                  <select name="remuneration_id" id="remuneration_id" class="form-control form-control-sm" >
                                                     ...
                                                     @foreach($remuneration_list as $payment)
	  ...
	  $.ajax({
	   ...
	   success:function(data){
		...
		if(data.errors){
			...
			$("#rpt_remuneration_id").val($("#remuneration_id").find(":selected").val());
