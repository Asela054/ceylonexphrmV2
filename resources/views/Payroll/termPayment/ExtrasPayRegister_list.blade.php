                        ...
                        <div class="container-fluid">
                            <div class="page-header-content py-3 px-2">
                                <h1 class="page-header-title ">
                                    ...
                                    <span>Advance Payments Register - Section wise</span>
                                </h1>
                            </div>
                        </div>
                    </div>
                                    ...
                                    {{ csrf_field() }}
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0 p-2">
                                                <div class="row">
                                                	<div class="col-12 text-right">
                                                    	<div>
                                                            ...
                                                            <button type="submit" name="print_record" id="print_record_pdf" disabled="disabled" class="btn btn-secondary btn-sm btn-light" onclick="this.form.action='{{ url('DownloadExtraPayRegister') }}'" style="width:auto;" value="2">Download PDF</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <hr />
                                                <div id="divPrint" class="datatable table-responsive dt_scroll_bars" style="margin-top:0px;">
                                   ...
                                   <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col">
                                                   <select name="period_filter_id" id="period_filter_id" class="form-control form-control-sm" style="" >
                                                        <option value="" disabled="disabled" selected="selected">Please Select</option>
...
$(document).ready(function(){
	...
	var empTable=$("#emptable").DataTable({
			"columns":[{data:'reg_indexno'}, {data:'emp_epfno'}, {data:'emp_first_name'}, 
				{data:'col_advance'}, {data:'col_dialogbill'}, {data:'col_otherdeduction'}, 
				{data:'net_amount'}],
			"order":[],
