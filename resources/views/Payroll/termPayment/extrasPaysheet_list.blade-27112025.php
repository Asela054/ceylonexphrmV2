                                    ...
                                    {{ csrf_field() }}
                                        <div class="card card-header-actions mb-4">
                                            <div class="card-header">
                                                Employee Advance/Bonus Payments
                                   ...
                                   <div class="modal-body">
                                        ...
                                        <div class="row">
                                        	<div class="form-group col-md-6">
                                               ...
                                               <div class="col">
                                                 <select name="payroll_process_type_id" id="payroll_process_type_id" class="form-control" ><!-- disabled="disabled" -->
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="col">
                                                   <select name="period_filter_id" id="period_filter_id" class="custom-select" style="" ><!-- disabled="disabled" -->
                                                        <option value="" disabled="disabled" selected="selected">Please Select</option>
